...
//	wp_register_style('fonts', '//fonts.googleapis.com/css2?family=Roboto:wght@300;400;500;700;900&display=swap');
		wp_register_style('main', get_template_directory_uri() . $assets['/assets/css/bundle.css']);
